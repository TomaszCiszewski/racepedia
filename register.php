...
<main>
  <div class="register-card">
    <h2 class="text-center mb-4"><i class="fas fa-user-plus me-2"></i>Rejestracja</h2>
    ...
    <form method="POST" action="backend/register_process.php">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="username" class="form-control" placeholder="Wymyśl login" required>
      </div>
      
      <div class="mb-4">
        <label class="form-label">Hasło</label>
        <input type="password" name="password" class="form-control" placeholder="Wymyśl hasło" required>
      </div>
    ...
    <div class="text-center">
      <p class="text-secondary">Masz już konto?</p>
